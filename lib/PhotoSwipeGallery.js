...
var PhotoSwipeGallery = _wrapComponent('PhotoSwipeGallery')((_temp = _class = function (_Component) {
    (0, _inherits3.default)(PhotoSwipeGallery, _Component);

    function PhotoSwipeGallery(props, context) {
        (0, _classCallCheck3.default)(this, PhotoSwipeGallery);

        var _this = (0, _possibleConstructorReturn3.default)(this, (PhotoSwipeGallery.__proto__ || (0, _getPrototypeOf2.default)(PhotoSwipeGallery)).call(this, props, context));
    ...
    (0, _createClass3.default)(PhotoSwipeGallery, [{
        ...
        value: function render() {
            ...
            var eventProps = (0, _lodash.pick)(other, _events2.default);
    ...
    thumbnailContent: _react2.PropTypes.func,
